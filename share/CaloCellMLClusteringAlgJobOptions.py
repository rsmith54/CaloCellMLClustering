...
svcMgr.EventSelector.InputCollections=["/afs/cern.ch/user/a/asgbase/patspace/xAODs/r7657/valid1.110401.PowhegPythia_P2012_ttbar_nonallhad.recon.AOD.e3099_s2578_r7657/AOD.07803411._000101.pool.root.1"]   #insert your list of input files here

algseq = CfgMgr.AthSequencer("AthAlgSeq")                #gets the main AthSequencer
algseq += CfgMgr.CaloCellMLClusteringAlg()                                 #adds an instance of your alg to it
...
#xaodStream.AddAcceptAlgs( "CaloCellMLClusteringAlg" ) #will only keep events where 'setFilterPassed(false)' has NOT been called in the given algorithm
